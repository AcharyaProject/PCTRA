...
if __name__ == '__main__':
    ...
    parser.add_argument('--anomaly_detection_enabled', type=bool, default=True)
    parser.add_argument('--local_global_blend_alpha', type=float, default=0)
    parser.add_argument('--epochs', type=str, default='', help='Optional override for num.max.epoch in config')
    ...
    # Keep custom dataset names as provided for user-supplied data folders.
    ...
    if args.epochs:
        conf.__setitem__('num.max.epoch', args.epochs)
